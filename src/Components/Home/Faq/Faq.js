      ...
      <Container>
        <div className="row text-center my-5 py-5">
          ...
          <div className="col-6">
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0"  alwaysOpen>
                <Accordion.Header>What kind of data can I see in FieldX?</Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="1" className='my-5'>
                <Accordion.Header>Does Bizzy read my customers' data?</Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="2" className='my-5'>
                <Accordion.Header>What's your refund and cancellation policy?</Accordion.Header>
                <Accordion.Body>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco
          ...
          <Accordion defaultActiveKey="0">
              ...
              <Accordion.Item eventKey="2" className='my-5'>
                <Accordion.Header>Can I also track website analytics on fieldX?</Accordion.Header>
                <Accordion.Body>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco
              ...
              <Accordion.Item eventKey="3" className='my-5'>
                <Accordion.Header>What makes Bizzy different from other analytics tools?</Accordion.Header>
                <Accordion.Body>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                  Ut enim ad minim veniam, quis nostrud exercitation ullamco
